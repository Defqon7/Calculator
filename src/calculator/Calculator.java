...
public class Calculator extends javax.swing.JFrame{
    ...
    private void btnLogTenActionPerformed(java.awt.event.ActionEvent evt) {                                          
        String num = textField.getText();
        double doubleNum = Double.parseDouble(num);
    ...
    private void btnCotActionPerformed(java.awt.event.ActionEvent evt) {                                       
        String num = textField.getText();
        double doubleNum = Double.parseDouble(num);
    ...
    private void btnOpenParenthActionPerformed(java.awt.event.ActionEvent evt) {                                               
        String num = textField.getText() + btnOpenParenth.getText();
        textField.setText(num);
    }                                              

    private void btnClosedParenthActionPerformed(java.awt.event.ActionEvent evt) {                                                 
